...
import { createNewToken, getProfile, login, register, logout, getFriends, updateOnlineStatus } from '@controllers/User.controller'
...
userRouter.post("/online-status", authenticate(), updateOnlineStatus)
